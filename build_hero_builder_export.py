#!/usr/bin/env python3
"""Export heroes.json and synergies.json for HoMM Olden Era hero builder."""
...
SYNERGIES = [
    {"skill": "Offense", "subskill": "Battle March", "requires": "Luck", "effect": "Focus per attack bonus is doubled", "effectRu": "Бонус Focus за атаку удваивается"},
    ...
    {"skill": "Offense", "subskill": "One for All", "requires": "Tactics", "effect": "Attack per adjacent enemy bonus is doubled", "effectRu": "Бонус Attack за соседних врагов удваивается"},
    ...
    {"skill": "Defence", "subskill": "Hymn to the Martyrs", "requires": "Recruitment", "effect": "Focus when taking damage bonus is doubled", "effectRu": "Бонус Focus при получении урона удваивается"},
    ...
    {"skill": "Defence", "subskill": "All for One", "requires": "Tactics", "effect": "Defense per adjacent ally bonus is doubled", "effectRu": "Бонус Defense за соседних союзников удваивается"},
    {"skill": "Defence", "subskill": "Avatar of Toughness", "requires": "Summon Avatar", "effect": "Avatar Defense scaling bonus is doubled", "effectRu": "Бонус Defense аватара удваивается"},
    {"skill": "Battlecraft", "subskill": "Resolve", "requires": "Leadership", "effect": "Extra turn chance per Morale bonus is doubled", "effectRu": "Бонус шанса доп. хода за Morale удваивается"},
    ...
    {"skill": "Battlecraft", "subskill": "Battle Focus", "requires": "Battle Magic", "effect": "+1 Focus Charge at round start is doubled", "effectRu": "+1 Focus Charge в начале раунда удваивается"},
    {"skill": "Battlecraft", "subskill": "Manacraft", "requires": "Recruitment", "effect": "Max mana from Attack/Defense bonus is doubled", "effectRu": "Бонус макс. маны от Attack/Defense удваивается"},
    {"skill": "Leadership", "subskill": "Avatar of Fury", "requires": "Summon Avatar", "effect": "Avatar Attack scaling bonus is doubled", "effectRu": "Бонус Attack аватара удваивается"},
    ...
    {"skill": "Luck", "subskill": "Battle March", "requires": "Offense", "effect": "Focus per attack bonus is doubled", "effectRu": "Бонус Focus за атаку удваивается"},
    ...
    {"skill": "Luck", "subskill": "Beastly Confidence", "requires": "Primal Magic", "effect": "Lucky Strike chance per Luck bonus is doubled", "effectRu": "Бонус шанса Lucky Strike за Luck удваивается"},
    ...
    {"skill": "Resistance", "subskill": "Chronic Weakness", "requires": "Nightshade Magic", "effect": "Chronic Weakness effect is doubled", "effectRu": "Эффект Chronic Weakness удваивается"},
    {"skill": "Resistance", "subskill": "Mage Protector's Authority", "requires": "Battle Magic", "effect": "Defense from Knowledge bonus is doubled", "effectRu": "Бонус Defense от Knowledge удваивается"},
    {"skill": "Tactics", "subskill": "One for All", "requires": "Offense", "effect": "Attack per adjacent enemy bonus is doubled", "effectRu": "Бонус Attack за соседних врагов удваивается"},
    {"skill": "Tactics", "subskill": "All for One", "requires": "Defence", "effect": "Defense per adjacent ally bonus is doubled", "effectRu": "Бонус Defense за соседних союзников удваивается"},
    {"skill": "Tactics", "subskill": "Elite Guards", "requires": "Recruitment", "effect": "T1–T3 Attack/Defense bonus is doubled", "effectRu": "Бонус Attack/Defense T1–T3 удваивается"},
    ...
    {"skill": "Recruitment", "subskill": "Manacraft", "requires": "Battlecraft", "effect": "Max mana from Attack/Defense bonus is doubled", "effectRu": "Бонус макс. маны от Attack/Defense удваивается"},
    {"skill": "Recruitment", "subskill": "Hymn to the Martyrs", "requires": "Defence", "effect": "Focus when taking damage bonus is doubled", "effectRu": "Бонус Focus при получении урона удваивается"},
    {"skill": "Recruitment", "subskill": "Elite Guards", "requires": "Tactics", "effect": "T1–T3 Attack/Defense bonus is doubled", "effectRu": "Бонус Attack/Defense T1–T3 удваивается"},
    ...
    {"skill": "Wisdom", "subskill": "Stargazer", "requires": "Scouting", "effect": "+250 Astrology Points/day is doubled", "effectRu": "Бонус +250 Astrology Points/день удваивается"},
    ...
    {"skill": "Battle Magic", "subskill": "Battle Focus", "requires": "Battlecraft", "effect": "+1 Focus Charge at round start is doubled", "effectRu": "+1 Focus Charge в начале раунда удваивается"},
    {"skill": "Battle Magic", "subskill": "Chaos Reigns", "requires": "Primal Magic", "effect": "Chaos Reigns effect is doubled", "effectRu": "Эффект Chaos Reigns удваивается"},
    {"skill": "Battle Magic", "subskill": "Battle Mage's Authority", "requires": "Sorcery", "effect": "Attack +20% from Spell Power is doubled", "effectRu": "Бонус Attack +20% от Spell Power удваивается"},
    {"skill": "Battle Magic", "subskill": "Mage Protector's Authority", "requires": "Resistance", "effect": "Defense +20% from Knowledge is doubled", "effectRu": "Бонус Defense +20% от Knowledge удваивается"},
    ...
    {"skill": "Sorcery", "subskill": "Battle Mage's Authority", "requires": "Battle Magic", "effect": "Attack +20% from Spell Power is doubled", "effectRu": "Бонус Attack +20% от Spell Power удваивается"},
    ...
    {"skill": "Summon Avatar", "subskill": "Avatar of Fury", "requires": "Leadership", "effect": "Avatar Attack scaling bonus is doubled", "effectRu": "Бонус Attack аватара удваивается"},
    {"skill": "Summon Avatar", "subskill": "Avatar of Toughness", "requires": "Defence", "effect": "Avatar Defense scaling bonus is doubled", "effectRu": "Бонус Defense аватара удваивается"},
    {"skill": "Summon Avatar", "subskill": "Avatar of Celerity", "requires": "Insight", "effect": "Avatar Speed/Initiative +2 is doubled", "effectRu": "Бонус Speed/Initiative аватара удваивается"},
    {"skill": "Summon Avatar", "subskill": "All Life is Endless", "requires": "Arcane Magic", "effect": "Summon Avatar synergy effect is doubled", "effectRu": "Синергия Summon Avatar удваивается"},
    ...
    {"skill": "Nightshade Magic", "subskill": "Chronic Weakness", "requires": "Resistance", "effect": "Chronic Weakness effect is doubled", "effectRu": "Эффект Chronic Weakness удваивается"},
    ...
    {"skill": "Arcane Magic", "subskill": "All Life is Endless", "requires": "Summon Avatar", "effect": "Summon Avatar synergy effect is doubled", "effectRu": "Синергия Summon Avatar удваивается"},
    ...
    {"skill": "Primal Magic", "subskill": "Beastly Confidence", "requires": "Luck", "effect": "Lucky Strike chance per Luck bonus is doubled", "effectRu": "Бонус шанса Lucky Strike за Luck удваивается"},
    {"skill": "Primal Magic", "subskill": "Chaos Reigns", "requires": "Battle Magic", "effect": "Chaos Reigns effect is doubled", "effectRu": "Эффект Chaos Reigns удваивается"},
    ...
    {"skill": "Scouting", "subskill": "Stargazer", "requires": "Wisdom", "effect": "+250 Astrology Points/day is doubled", "effectRu": "Бонус +250 Astrology Points/день удваивается"},
    ...
    {"skill": "Economy", "subskill": "Experimenter", "requires": "Insight", "effect": "+5 Alchemical Dust bonus is doubled", "effectRu": "Бонус +5 Alchemical Dust удваивается"},
    {"skill": "Insight", "subskill": "Avatar of Celerity", "requires": "Summon Avatar", "effect": "Avatar Speed/Initiative +2 is doubled", "effectRu": "Бонус Speed/Initiative аватара удваивается"},
    ...
    {"skill": "Insight", "subskill": "Experimenter", "requires": "Economy", "effect": "+5 Alchemical Dust bonus is doubled", "effectRu": "Бонус +5 Alchemical Dust удваивается"},
...
def transform_hero(raw: dict, overrides: dict) -> dict:
    hid = raw["id"]
    ...
    out = {
        ...
        "specialtyDescRu": translate_ru(spec_desc, hid),
...
def main() -> None:
    ...
    heroes = [transform_hero(h, overrides) for h in data["heroes"]]
    heroes.sort(key=lambda x: (x["faction"], x["class"], x["name"]))

    (ROOT / "heroes.json").write_text(json.dumps(heroes, ensure_ascii=False, indent=2), encoding="utf-8")
    (ROOT / "synergies.json").write_text(json.dumps(SYNERGIES, ensure_ascii=False, indent=2), encoding="utf-8")

    # JS bundles for hero-builder
    (ROOT / "hero-builder-heroes.js").write_text(
        "/* Auto-generated by build_hero_builder_export.py */\n"
        f"window.HOE_BUILDER_HEROES = {json.dumps(heroes, ensure_ascii=False, indent=2)};\n",
        encoding="utf-8",
    )
    ...
    print(f"Exported {len(heroes)} heroes, {len(SYNERGIES)} synergies")
    from collections import Counter
    print("By faction:", dict(Counter(h["faction"] for h in heroes)))
